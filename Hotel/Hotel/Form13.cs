...
namespace Hotel
{
    public partial class Form13 : Form
    {
        ...
        private void Form13_Load(object sender, EventArgs e)
        {
            ...
            komanda.CommandText = "SELECT * FROM Sobe WHERE Tip_sobe = 'Dvokrevetna' AND Stanje = 'Slobodna'";
        ...
        private void Form13_MouseClick(object sender, MouseEventArgs e)
        {
            monthCalendar1.Visible = false;
            monthCalendar2.Visible = false;
        }
